...
public class pos extends JFrame implements ActionListener {
	ImageIcon img = new ImageIcon(new ImageIcon("bg.png").getImage().getScaledInstance(1040, 740, Image.SCALE_SMOOTH));
	JLabel background = new JLabel("", img, JLabel.CENTER);
	
	ImageIcon img2 = new ImageIcon(new ImageIcon("closebtn.png").getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH));
	JLabel close = new JLabel("", img2, JLabel.CENTER);
    
    ImageIcon img3 = new ImageIcon(new ImageIcon("leftarrow.jpg").getImage().getScaledInstance(30, 20, Image.SCALE_SMOOTH));
	JLabel back = new JLabel("", img3, JLabel.CENTER);	
//for Title----------------------------------------------------------------------------------------------------------
	JPanel title = new JPanel();
	JLabel Title=new JLabel("john wick store", JLabel.CENTER);
//for 2ndPanel----------------------------------------------------------------------------------------------------------
...
//				}else if (table.isRowSelected(selected)) {
//					
...
//						    JOptionPane.showMessageDialog(null, "Row already selected.", "Row selected", JOptionPane.WARNING_MESSAGE);
//						}	
//				     }
